...
@section('breadcrumb', 'Sửa slide')
@section('active-slide', 'active')
@section('contents')
<form action="{{ route('admin.slides.update', $slide->id) }}" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
    @csrf
    @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title" value="{{ $slide->title }}" style="width:100%">
                                </div>
                                @error('title')
